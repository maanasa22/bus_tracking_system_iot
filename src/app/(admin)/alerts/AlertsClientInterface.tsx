...
import { AlertTriangle, Bell, CheckCircle2, Info, ShieldAlert, Clock, Bus as BusIcon, MoreVertical } from "lucide-react";
...
export function AlertsClientInterface({ alerts }: { alerts: any[] }) {
